...
void TreeDiscreteChoice::post_bootstrap_init() {
  ...
  for (auto& sampleID : sampleIDs[0]) {
    ...
    std::cout << "extending " << a_id << " --> " << sampleID << std::endl;
...
void TreeDiscreteChoice::findBestSplitValueSmallQ(size_t nodeID, size_t varID, double sum_node, size_t num_samples_node,
...
void TreeDiscreteChoice::findBestSplitValueLargeQ(size_t nodeID, size_t varID, double sum_node, size_t num_samples_node,
    double& best_value, size_t& best_varID, double& best_decrease) {
...
void TreeDiscreteChoice::findBestSplitValueUnordered(size_t nodeID, size_t varID, double sum_node, size_t num_samples_node,
    double& best_value, size_t& best_varID, double& best_decrease) {
...
bool TreeDiscreteChoice::findBestSplitMaxstat(size_t nodeID, std::vector<size_t>& possible_split_varIDs) {
...
bool TreeDiscreteChoice::findBestSplitExtraTrees(size_t nodeID, std::vector<size_t>& possible_split_varIDs) {
...
void TreeDiscreteChoice::findBestSplitValueExtraTrees(size_t nodeID, size_t varID, double sum_node, size_t num_samples_node,
    double& best_value, size_t& best_varID, double& best_decrease) {
...
void TreeDiscreteChoice::findBestSplitValueExtraTreesUnordered(size_t nodeID, size_t varID, double sum_node,
